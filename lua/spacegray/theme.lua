...
function M.setup()
  ...
  theme.base = {
    ...
    Declaration = { fg = colors.lightyellow },
    ...
    Variable = { fg = colors.lightyellow },
  ...
  theme.plugins = {
    ...
    lsp = {
      ...
      LspDiagnosticsInfo = { fg = colors.gray },
      LspDiagnosticsHint = { fg = colors.foreground },
      ...
      LspDiagnosticsUnderlineError = { style = 'undercurl', sp = colors.red },
      LspDiagnosticsUnderlineWarn = { style = 'undercurl', sp = colors.yellow },
      LspDiagnosticsUnderlineInfo = { style = 'undercurl', sp = colors.gray },
      LspDiagnosticsUnderlineHint = { style = 'undercurl', sp = colors.foreground },
    ...
    telescope = {}, -- TODO
    treesitter = {
      TSConstant = { fg = colors.lightyellow },
      TSConstBuiltin = { fg = colors.lightyellow },
      TSField = { fg = colors.foreground },
      TSIdentifier = { fg = colors.yellow },
